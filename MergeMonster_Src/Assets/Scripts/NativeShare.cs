...
{
	private sealed class _delayedShare_c__Iterator1E : IEnumerator, IDisposable, IEnumerator<object>
	{
		...
		internal NativeShare __f__this;
	...
	public static NativeShare instane;

	private void Awake()
	{
		NativeShare.instane = this;
	}
	...
	{
		NativeShare._delayedShare_c__Iterator1E _delayedShare_c__Iterator1E = new NativeShare._delayedShare_c__Iterator1E();
		_delayedShare_c__Iterator1E.screenShotPath = screenShotPath;
		_delayedShare_c__Iterator1E.text = text;
		_delayedShare_c__Iterator1E.___screenShotPath = screenShotPath;
		_delayedShare_c__Iterator1E.___text = text;
		_delayedShare_c__Iterator1E.__f__this = this;
		return _delayedShare_c__Iterator1E;
	}
